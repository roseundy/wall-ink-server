<?php
    ...
    if ($_POST["new_device_id"] == "new") {
        $sql_query="INSERT INTO devices(mac_address,resource_id,orientation,device_type,plugin,is_production,only_events,qr,refresh,width,height,notes) VALUES (\"$mac\",\"$_POST[new_resource_id]\",$_POST[new_orientation],$_POST[new_device_type],$_POST[new_plugin],$_POST[new_production],$_POST[new_onlyevents],$_POST[new_qr],$_POST[new_refresh],$_POST[new_width],$_POST[new_height],\"$new_notes\")";
    } else {
        $sql_query="UPDATE devices SET mac_address = \"$mac\", resource_id = \"$_POST[new_resource_id]\", orientation = $_POST[new_orientation], plugin = $_POST[new_plugin], device_type = $_POST[new_device_type], is_production = $_POST[new_production], only_events = $_POST[new_onlyevents], qr = $_POST[new_qr], refresh = $_POST[new_refresh], width = $_POST[new_width], height = $_POST[new_height], notes = '$new_notes' WHERE device_id = $_POST[new_device_id]";
    }
