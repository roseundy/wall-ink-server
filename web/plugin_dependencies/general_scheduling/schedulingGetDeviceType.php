...
function schedulingGetDeviceType($device, $pluginIndex) {
    ...
    $validDeviceTypes = array(0,2,3,10,11,12);
    ...
    $getDeviceType .= "\">";
        ...
        if (in_array(0, $validDeviceTypes)) {
            $getDeviceType .= "<li>";
                $getDeviceType .= "<label for=\"0\">7\" Portrait, all events</label>";
        ...
        if (in_array(2, $validDeviceTypes)) {
            $getDeviceType .= "<li>";
                $getDeviceType .= "<label for=\"2\">7\" Landscape 2 events</label>";
        ...
        if (in_array(3, $validDeviceTypes)) {
            $getDeviceType .= "<li>";
                $getDeviceType .= "<label for=\"3\">7\" Landscape 2+ events</label>";
        ...
        if (in_array(10, $validDeviceTypes)) {
            $getDeviceType .= "<li>";
                $getDeviceType .= "<label for=\"10\">7\" Landscape 2 events, better battery</label>";
        ...
        if (in_array(11, $validDeviceTypes)) {
            $getDeviceType .= "<li>";
                $getDeviceType .= "<label for=\"11\">7\" Landscape for event spaces</label>";
        ...
        if (in_array(12, $validDeviceTypes)) {
            $getDeviceType .= "<li>";
                $getDeviceType .= "<label for=\"12\">7\" Landscape 2 events, no bottom bar</label>";
